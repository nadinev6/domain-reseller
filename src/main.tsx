...
// Simple fallback for Lingo.dev components
const LingoProviderWrapper = ({ children }: { children: React.ReactNode }) => <>{children}</>;
const loadDictionary = (locale: string) => Promise.resolve({});
import { z } from 'zod';
import './index.css';
